// THE BREATHING IN AND OUT FILE
// IDK HOW I DID THIS OR WHY IT WORKS!
...
void main()	{
    ...
    // original was "pos.xy += curl(pos.xyz*2., time*0.1, 0.1).xy * 0.006" CHANGE (* 0.006) to edit
	pos.xy += curl(pos.xyz*2., time*0.1, 0.1).xy * 0.0;
