  ...
  return (
    <nav
      ...
      style={{
        ...
        top: "20px", 
        background:
          "linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(50, 50, 50, 0))",
    ...
    >
      ...
      >
        <div className="flex items-center justify-center sm:justify-between h-full relative px-4 sm:px-12 w-full">
          {/* Hamburger Button - Visible on Mobile */}
          <button
            className="sm:hidden text-white focus:outline-none items-center"
